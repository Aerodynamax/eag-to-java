...
exports.addDashesToUUID = void 0;
...
function addDashesToUUID(uuid) {
    if (!(0, typeAssertion_1.isStringUUID)(uuid, false))
        throw new TypeError('The uuid argument should be a valid uuid (with no dashes) with a type of string');
