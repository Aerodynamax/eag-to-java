...
exports.generateV4 = void 0;
const node_crypto_1 = require("node:crypto");
const parseUUID_1 = require("../utils/parseUUID");
/**
...
function generateV4(options) {
    const generated = (0, node_crypto_1.randomUUID)(options);
    return (0, parseUUID_1.parseUUID)(generated, true);
}
